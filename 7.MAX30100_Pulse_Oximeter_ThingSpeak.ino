...
const char* ssid = "Shemanto Wifi";// write your ssid
const char* password = "ssssssss";//write your ssid password here
 
// Your thingspeak channel url with api_key query
String serverName = "https://api.thingspeak.com/update?api_key=ATPQC3MEYSVZTOH8";//add your Thingspeak key here
